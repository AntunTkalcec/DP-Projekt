...
#mode save
#mode nocomment "%"
#define FLORA_THIS_FILENAME  'flora.flr'
#mode restore
/************************************************************************
...
#mode save
#mode nocomment "%"
#define FLORA_FDB_FILENAME  'flora.fdb'
#mode restore
...
#mode save
#mode nocomment "%"
#define FLORA_FLD_FILENAME  'flora.fld'
#mode restore
...
#mode save
#mode nocomment "%"
#define FLORA_FLS_FILENAME  'flora.fls'
#mode restore
...
#mode save
#mode nocomment "%"
#define FLORA_FLS2_FILENAME  'flora.fls2'
#mode restore
